...
- [x] Week 1 Task Creating Singup/Login Page using HTML Only
 ...
 ## My learning in Week 1
    This is the very first time i have ever worked with html, and the first week has been astonishing for me, <br>
    for what i have learnt in the past week starting from what is html and <br>
    why are we still using it for the webpage structure although i just got the glimpse of html in the first week <br>
